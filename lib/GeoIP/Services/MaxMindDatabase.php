...
class MaxMindDatabase
{
    ...
    public function update()
    {
        ...
        $this->withTemporaryDirectory(function ($directory) {
            ...
            file_put_contents($tarFile, fopen(Config::$geoip_update_url, 'r'));
            ...
            file_put_contents(Config::$geoip_db_path, fopen("{$directory}/{$relativePath}", 'r'));
        });

        return "Database file (".Config::$geoip_db_path.") updated.";
    }
